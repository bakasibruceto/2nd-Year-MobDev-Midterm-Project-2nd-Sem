...
//BA.debugLineNum = 5;BA.debugLine="WinPanel.SetLeftAndRight (0,100%x)"[GameDefeated/General script]
views.get("winpanel").vw.setLeft((int)(0d));
views.get("winpanel").vw.setWidth((int)((100d / 100 * width) - (0d)));
//BA.debugLineNum = 6;BA.debugLine="WinPanel.SetTopAndBottom (0,100%y)"[GameDefeated/General script]
views.get("winpanel").vw.setTop((int)(0d));
views.get("winpanel").vw.setHeight((int)((100d / 100 * height) - (0d)));
//BA.debugLineNum = 9;BA.debugLine="ButtonTitle.HorizontalCenter = WinPanel.Width/2"[GameDefeated/General script]
views.get("buttontitle").vw.setLeft((int)((views.get("winpanel").vw.getWidth())/2d - (views.get("buttontitle").vw.getWidth() / 2)));
//BA.debugLineNum = 10;BA.debugLine="ButtonTitle.VerticalCenter = WinPanel.Height/2"[GameDefeated/General script]
views.get("buttontitle").vw.setTop((int)((views.get("winpanel").vw.getHeight())/2d - (views.get("buttontitle").vw.getHeight() / 2)));
//BA.debugLineNum = 12;BA.debugLine="Retry.HorizontalCenter = WinPanel.Width/2"[GameDefeated/General script]
views.get("retry").vw.setLeft((int)((views.get("winpanel").vw.getWidth())/2d - (views.get("retry").vw.getWidth() / 2)));
//BA.debugLineNum = 13;BA.debugLine="Retry.VerticalCenter = WinPanel.Height/1.4"[GameDefeated/General script]
