...
//BA.debugLineNum = 29;BA.debugLine="Panel2.VerticalCenter = Panel1.Height/1.25"[GameState/General script]
views.get("panel2").vw.setTop((int)((views.get("panel1").vw.getHeight())/1.25d - (views.get("panel2").vw.getHeight() / 2)));
//BA.debugLineNum = 31;BA.debugLine="Panel3.HorizontalCenter = Panel1.Width/1.89"[GameState/General script]
