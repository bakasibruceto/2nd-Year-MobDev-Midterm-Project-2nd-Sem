...
try {
		Debug.PushSubsStack("Button0_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,253);
if (RapidSub.canDelegate("button0_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button0_click");}
 BA.debugLineNum = 253;BA.debugLine="Private Sub Button0_Click";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 254;BA.debugLine="answer.Text = tempStr&\"0\"";
Debug.ShouldStop(536870912);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("0"))));
 BA.debugLineNum = 255;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("Button1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,259);
if (RapidSub.canDelegate("button1_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button1_click");}
 BA.debugLineNum = 259;BA.debugLine="Private Sub Button1_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 260;BA.debugLine="answer.Text = tempStr&\"1\"";
Debug.ShouldStop(8);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("1"))));
 BA.debugLineNum = 261;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(16);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("Button2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,264);
if (RapidSub.canDelegate("button2_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button2_click");}
 BA.debugLineNum = 264;BA.debugLine="Private Sub Button2_Click";
Debug.ShouldStop(128);
 BA.debugLineNum = 265;BA.debugLine="answer.Text = tempStr&\"2\"";
Debug.ShouldStop(256);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("2"))));
 BA.debugLineNum = 266;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(512);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("Button3_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,269);
if (RapidSub.canDelegate("button3_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button3_click");}
 BA.debugLineNum = 269;BA.debugLine="Private Sub Button3_Click";
Debug.ShouldStop(4096);
 BA.debugLineNum = 270;BA.debugLine="answer.Text = tempStr&\"3\"";
Debug.ShouldStop(8192);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("3"))));
 BA.debugLineNum = 271;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(16384);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("Button4_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,274);
if (RapidSub.canDelegate("button4_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button4_click");}
 BA.debugLineNum = 274;BA.debugLine="Private Sub Button4_Click";
Debug.ShouldStop(131072);
 BA.debugLineNum = 275;BA.debugLine="answer.Text = tempStr&\"4\"";
Debug.ShouldStop(262144);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("4"))));
 BA.debugLineNum = 276;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(524288);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("Button5_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,279);
if (RapidSub.canDelegate("button5_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button5_click");}
 BA.debugLineNum = 279;BA.debugLine="Private Sub Button5_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 280;BA.debugLine="answer.Text = tempStr&\"5\"";
Debug.ShouldStop(8388608);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("5"))));
 BA.debugLineNum = 281;BA.debugLine="tempStr = answer.Text";
...
try {
		Debug.PushSubsStack("Button6_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,284);
if (RapidSub.canDelegate("button6_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button6_click");}
 BA.debugLineNum = 284;BA.debugLine="Private Sub Button6_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 285;BA.debugLine="answer.Text = tempStr&\"6\"";
Debug.ShouldStop(268435456);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("6"))));
 BA.debugLineNum = 286;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(536870912);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("Button7_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,289);
if (RapidSub.canDelegate("button7_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button7_click");}
 BA.debugLineNum = 289;BA.debugLine="Private Sub Button7_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 290;BA.debugLine="answer.Text = tempStr&\"7\"";
Debug.ShouldStop(2);
...
try {
		Debug.PushSubsStack("Button8_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,294);
if (RapidSub.canDelegate("button8_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button8_click");}
 BA.debugLineNum = 294;BA.debugLine="Private Sub Button8_Click";
Debug.ShouldStop(32);
 BA.debugLineNum = 295;BA.debugLine="answer.Text = tempStr&\"8\"";
Debug.ShouldStop(64);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("8"))));
 BA.debugLineNum = 296;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(128);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("Button9_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,299);
if (RapidSub.canDelegate("button9_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button9_click");}
 BA.debugLineNum = 299;BA.debugLine="Private Sub Button9_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 300;BA.debugLine="answer.Text = tempStr&\"9\"";
Debug.ShouldStop(2048);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("9"))));
 BA.debugLineNum = 301;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(4096);
main.mostCurrent._tempstr = main.mostCurrent._answer.runMethod(true,"getText");
...
try {
		Debug.PushSubsStack("ButtonClear_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,247);
if (RapidSub.canDelegate("buttonclear_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","buttonclear_click");}
 BA.debugLineNum = 247;BA.debugLine="Private Sub ButtonClear_Click";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 248;BA.debugLine="answer.Text=\"\"";
Debug.ShouldStop(8388608);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 249;BA.debugLine="tempStr=\"\"";
Debug.ShouldStop(16777216);
...
try {
		Debug.PushSubsStack("ButtonEnter_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,224);
if (RapidSub.canDelegate("buttonenter_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","buttonenter_click");}
 BA.debugLineNum = 224;BA.debugLine="Private Sub ButtonEnter_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 225;BA.debugLine="tempStr=\"\"";
Debug.ShouldStop(1);
main.mostCurrent._tempstr = BA.ObjectToString("");
 BA.debugLineNum = 226;BA.debugLine="dammage = str";
Debug.ShouldStop(2);
main._dammage = BA.numberCast(int.class, main.mostCurrent._str);
 BA.debugLineNum = 227;BA.debugLine="If answer.Text = str Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",main.mostCurrent._answer.runMethod(true,"getText"),main.mostCurrent._str)) { 
 BA.debugLineNum = 228;BA.debugLine="strAn.Text = \"Correct\"";
Debug.ShouldStop(8);
main.mostCurrent._stran.runMethod(true,"setText",BA.ObjectToCharSequence("Correct"));
 BA.debugLineNum = 230;BA.debugLine="mobVal= mobVal-dammage";
Debug.ShouldStop(32);
main._mobval = RemoteObject.solve(new RemoteObject[] {main._mobval,main._dammage}, "-",1, 1);
 }else {
 BA.debugLineNum = 233;BA.debugLine="strAn.Text = \"InCorrect\"";
Debug.ShouldStop(256);
main.mostCurrent._stran.runMethod(true,"setText",BA.ObjectToCharSequence("InCorrect"));
 BA.debugLineNum = 234;BA.debugLine="HPval = HPval-dammage";
Debug.ShouldStop(512);
main._hpval = RemoteObject.solve(new RemoteObject[] {main._hpval,main._dammage}, "-",1, 1);
 };
 BA.debugLineNum = 238;BA.debugLine="GameState.Visible=False";
Debug.ShouldStop(8192);
main.mostCurrent._gamestate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 239;BA.debugLine="RemoveViews";
Debug.ShouldStop(16384);
_removeviews();
 BA.debugLineNum = 240;BA.debugLine="Activity_Create(True)";
Debug.ShouldStop(32768);
_activity_create(main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 241;BA.debugLine="check = True";
Debug.ShouldStop(65536);
main._check = main.mostCurrent.__c.getField(true,"True");
 BA.debugLineNum = 242;BA.debugLine="If HPval <= 100 And HPval >= 0 Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("k",main._hpval,BA.numberCast(double.class, 100)) && RemoteObject.solveBoolean("g",main._hpval,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 243;BA.debugLine="GameState.Visible=True";
Debug.ShouldStop(262144);
...
try {
		Debug.PushSubsStack("Retry_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,304);
if (RapidSub.canDelegate("retry_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","retry_click");}
 BA.debugLineNum = 304;BA.debugLine="Private Sub Retry_Click";
Debug.ShouldStop(32768);
 BA.debugLineNum = 306;BA.debugLine="HPval = 100";
Debug.ShouldStop(131072);
main._hpval = BA.numberCast(int.class, 100);
 BA.debugLineNum = 307;BA.debugLine="mobVal = 500";
Debug.ShouldStop(262144);
main._mobval = BA.numberCast(int.class, 500);
 BA.debugLineNum = 309;BA.debugLine="GameOverState.Visible = False";
Debug.ShouldStop(1048576);
main.mostCurrent._gameoverstate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 310;BA.debugLine="RemoveViews";
Debug.ShouldStop(2097152);
_removeviews();
 BA.debugLineNum = 311;BA.debugLine="Activity_Create(True)";
Debug.ShouldStop(4194304);
_activity_create(main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 312;BA.debugLine="GameState.Visible = True";
Debug.ShouldStop(8388608);
main.mostCurrent._gamestate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 313;BA.debugLine="time(True)";
Debug.ShouldStop(16777216);
