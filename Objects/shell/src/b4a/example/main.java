...
public static RemoteObject _mediaplayer2 = RemoteObject.declareNull("anywheresoftware.b4a.objects.MediaPlayerWrapper");
...
public static RemoteObject _equal = RemoteObject.declareNull("anywheresoftware.b4a.objects.LabelWrapper");
public static RemoteObject _pausepanel = RemoteObject.declareNull("anywheresoftware.b4a.objects.PanelWrapper");
...
public static RemoteObject _bar = RemoteObject.createImmutable(0);
...
public static RemoteObject _hpshake = RemoteObject.createImmutable(false);
public static RemoteObject _mobshake = RemoteObject.createImmutable(false);
...
public static b4a.example.xuiviewsutils _xuiviewsutils = null;
  public Object[] GetGlobals() {
		return new Object[] {"Activity",main.mostCurrent._activity,"answer",main.mostCurrent._answer,"bar",main._bar,"barsize",main._barsize,"Button0",main.mostCurrent._button0,"Button1",main.mostCurrent._button1,"Button2",main.mostCurrent._button2,"Button3",main.mostCurrent._button3,"Button4",main.mostCurrent._button4,"Button5",main.mostCurrent._button5,"Button6",main.mostCurrent._button6,"Button7",main.mostCurrent._button7,"Button8",main.mostCurrent._button8,"Button9",main.mostCurrent._button9,"ButtonClear",main.mostCurrent._buttonclear,"ButtonEnter",main.mostCurrent._buttonenter,"check",main._check,"cvsGraph",main.mostCurrent._cvsgraph,"cvsGraph2",main.mostCurrent._cvsgraph2,"cvsGraph3",main.mostCurrent._cvsgraph3,"cvsGraph4",main.mostCurrent._cvsgraph4,"damage",main._damage,"DateUtils",main.mostCurrent._dateutils,"equal",main.mostCurrent._equal,"FileName",main._filename,"Font",main._font,"GameDefeated",main.mostCurrent._gamedefeated,"GameOverState",main.mostCurrent._gameoverstate,"GameState",main.mostCurrent._gamestate,"HP",main.mostCurrent._hp,"hpshake",main._hpshake,"HPval",main._hpval,"ImageView1",main.mostCurrent._imageview1,"MediaPlayer",main._mediaplayer,"MediaPlayer2",main._mediaplayer2,"mob",main.mostCurrent._mob,"mob2",main.mostCurrent._mob2,"mobHP",main.mostCurrent._mobhp,"mobshake",main._mobshake,"mobVal",main._mobval,"Monster",main._monster,"MonsterType",main._monstertype,"num1",main.mostCurrent._num1,"num2",main.mostCurrent._num2,"operation",main.mostCurrent._operation,"operator",main.mostCurrent._operator,"Panel2",main.mostCurrent._panel2,"PausePanel",main.mostCurrent._pausepanel,"PauseState",main.mostCurrent._pausestate,"ply1",main.mostCurrent._ply1,"ply2",main.mostCurrent._ply2,"rect1",main.mostCurrent._rect1,"rect2",main.mostCurrent._rect2,"rect3",main.mostCurrent._rect3,"rect4",main.mostCurrent._rect4,"shake",main.mostCurrent._shake,"Starter",Debug.moduleToString(b4a.example.starter.class),"str",main.mostCurrent._str,"strAn",main.mostCurrent._stran,"tempStr",main.mostCurrent._tempstr,"TitleState",main.mostCurrent._titlestate,"xui",main._xui,"XUIViewsUtils",Debug.moduleToString(b4a.example.xuiviewsutils.class)};
}
}