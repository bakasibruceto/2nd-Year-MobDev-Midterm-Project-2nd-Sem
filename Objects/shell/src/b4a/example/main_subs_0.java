...
try {
		Debug.PushSubsStack("Button0_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,321);
if (RapidSub.canDelegate("button0_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button0_click");}
 BA.debugLineNum = 321;BA.debugLine="Private Sub Button0_Click";
Debug.ShouldStop(1);
 BA.debugLineNum = 322;BA.debugLine="answer.Text = tempStr&\"0\"";
Debug.ShouldStop(2);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(RemoteObject.concat(main.mostCurrent._tempstr,RemoteObject.createImmutable("0"))));
 BA.debugLineNum = 323;BA.debugLine="tempStr = answer.Text";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("Button1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,327);
if (RapidSub.canDelegate("button1_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button1_click");}
 BA.debugLineNum = 327;BA.debugLine="Private Sub Button1_Click";
Debug.ShouldStop(64);
 BA.debugLineNum = 328;BA.debugLine="answer.Text = tempStr&\"1\"";
...
try {
		Debug.PushSubsStack("Button2_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,332);
if (RapidSub.canDelegate("button2_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button2_click");}
 BA.debugLineNum = 332;BA.debugLine="Private Sub Button2_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 333;BA.debugLine="answer.Text = tempStr&\"2\"";
...
try {
		Debug.PushSubsStack("Button3_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,337);
if (RapidSub.canDelegate("button3_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button3_click");}
 BA.debugLineNum = 337;BA.debugLine="Private Sub Button3_Click";
Debug.ShouldStop(65536);
 BA.debugLineNum = 338;BA.debugLine="answer.Text = tempStr&\"3\"";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("Button4_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,342);
if (RapidSub.canDelegate("button4_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button4_click");}
 BA.debugLineNum = 342;BA.debugLine="Private Sub Button4_Click";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 343;BA.debugLine="answer.Text = tempStr&\"4\"";
Debug.ShouldStop(4194304);
...
try {
		Debug.PushSubsStack("Button5_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,347);
if (RapidSub.canDelegate("button5_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button5_click");}
 BA.debugLineNum = 347;BA.debugLine="Private Sub Button5_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 348;BA.debugLine="answer.Text = tempStr&\"5\"";
Debug.ShouldStop(134217728);
...
try {
		Debug.PushSubsStack("Button6_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,352);
if (RapidSub.canDelegate("button6_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button6_click");}
 BA.debugLineNum = 352;BA.debugLine="Private Sub Button6_Click";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 353;BA.debugLine="answer.Text = tempStr&\"6\"";
Debug.ShouldStop(1);
...
try {
		Debug.PushSubsStack("Button7_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,357);
if (RapidSub.canDelegate("button7_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button7_click");}
 BA.debugLineNum = 357;BA.debugLine="Private Sub Button7_Click";
Debug.ShouldStop(16);
 BA.debugLineNum = 358;BA.debugLine="answer.Text = tempStr&\"7\"";
Debug.ShouldStop(32);
...
try {
		Debug.PushSubsStack("Button8_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,362);
if (RapidSub.canDelegate("button8_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button8_click");}
 BA.debugLineNum = 362;BA.debugLine="Private Sub Button8_Click";
Debug.ShouldStop(512);
 BA.debugLineNum = 363;BA.debugLine="answer.Text = tempStr&\"8\"";
...
try {
		Debug.PushSubsStack("Button9_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,367);
if (RapidSub.canDelegate("button9_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","button9_click");}
 BA.debugLineNum = 367;BA.debugLine="Private Sub Button9_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 368;BA.debugLine="answer.Text = tempStr&\"9\"";
...
try {
		Debug.PushSubsStack("ButtonClear_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,315);
if (RapidSub.canDelegate("buttonclear_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","buttonclear_click");}
 BA.debugLineNum = 315;BA.debugLine="Private Sub ButtonClear_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 316;BA.debugLine="answer.Text=\"\"";
Debug.ShouldStop(134217728);
main.mostCurrent._answer.runMethod(true,"setText",BA.ObjectToCharSequence(""));
 BA.debugLineNum = 317;BA.debugLine="tempStr=\"\"";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("ButtonEnter_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,283);
if (RapidSub.canDelegate("buttonenter_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","buttonenter_click");}
 BA.debugLineNum = 283;BA.debugLine="Private Sub ButtonEnter_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 284;BA.debugLine="tempStr=\"\"";
Debug.ShouldStop(134217728);
main.mostCurrent._tempstr = BA.ObjectToString("");
 BA.debugLineNum = 285;BA.debugLine="damage = str";
Debug.ShouldStop(268435456);
main._damage = BA.numberCast(int.class, main.mostCurrent._str);
 BA.debugLineNum = 286;BA.debugLine="If answer.Text = str Then";
Debug.ShouldStop(536870912);
if (RemoteObject.solveBoolean("=",main.mostCurrent._answer.runMethod(true,"getText"),main.mostCurrent._str)) { 
 BA.debugLineNum = 287;BA.debugLine="strAn.Text = \"Correct\"";
Debug.ShouldStop(1073741824);
main.mostCurrent._stran.runMethod(true,"setText",BA.ObjectToCharSequence("Correct"));
 BA.debugLineNum = 288;BA.debugLine="mobVal= mobVal-damage";
Debug.ShouldStop(-2147483648);
main._mobval = RemoteObject.solve(new RemoteObject[] {main._mobval,main._damage}, "-",1, 1);
 BA.debugLineNum = 289;BA.debugLine="mobshake = True";
Debug.ShouldStop(1);
main._mobshake = main.mostCurrent.__c.getField(true,"True");
 BA.debugLineNum = 290;BA.debugLine="MediaPlayer.Load(File.DirAssets,\"dam.mp3\")";
Debug.ShouldStop(2);
main._mediaplayer.runVoidMethod ("Load",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("dam.mp3")));
 ...
 BA.debugLineNum = 293;BA.debugLine="strAn.Text = \"InCorrect\"";
Debug.ShouldStop(16);
main.mostCurrent._stran.runMethod(true,"setText",BA.ObjectToCharSequence("InCorrect"));
 BA.debugLineNum = 294;BA.debugLine="HPval = HPval-damage";
Debug.ShouldStop(32);
main._hpval = RemoteObject.solve(new RemoteObject[] {main._hpval,main._damage}, "-",1, 1);
 BA.debugLineNum = 295;BA.debugLine="MediaPlayer.Play";
Debug.ShouldStop(64);
main._mediaplayer.runVoidMethod ("Play");
 BA.debugLineNum = 296;BA.debugLine="hpshake = True";
Debug.ShouldStop(128);
main._hpshake = main.mostCurrent.__c.getField(true,"True");
 BA.debugLineNum = 297;BA.debugLine="MediaPlayer.Load(File.DirAssets,\"pdam.mp3\")";
Debug.ShouldStop(256);
main._mediaplayer.runVoidMethod ("Load",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("pdam.mp3")));
 ...
 BA.debugLineNum = 299;BA.debugLine="MediaPlayer.Play";
Debug.ShouldStop(1024);
main._mediaplayer.runVoidMethod ("Play");
 BA.debugLineNum = 301;BA.debugLine="GameState.Visible=False";
Debug.ShouldStop(4096);
...
Debug.ShouldStop(4096);
 BA.debugLineNum = 271;BA.debugLine="HPval = 100";
Debug.ShouldStop(16384);
main._hpval = BA.numberCast(int.class, 100);
 BA.debugLineNum = 272;BA.debugLine="mobVal = 100";
Debug.ShouldStop(32768);
main._mobval = BA.numberCast(int.class, 100);
 BA.debugLineNum = 273;BA.debugLine="MonsterType = 0";
Debug.ShouldStop(65536);
main._monstertype = BA.numberCast(int.class, 0);
 BA.debugLineNum = 274;BA.debugLine="FileName = Monster(MonsterType)";
Debug.ShouldStop(131072);
main._filename = main._monster.getArrayElement(true,main._monstertype);
 BA.debugLineNum = 275;BA.debugLine="GameOverState.Visible = False";
Debug.ShouldStop(262144);
main.mostCurrent._gameoverstate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"False"));
 BA.debugLineNum = 276;BA.debugLine="ReDraw";
Debug.ShouldStop(524288);
_redraw();
 BA.debugLineNum = 277;BA.debugLine="Activity_Create(True)";
Debug.ShouldStop(1048576);
_activity_create(main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 278;BA.debugLine="GameState.Visible = True";
Debug.ShouldStop(2097152);
main.mostCurrent._gamestate.runMethod(true,"setVisible",main.mostCurrent.__c.getField(true,"True"));
