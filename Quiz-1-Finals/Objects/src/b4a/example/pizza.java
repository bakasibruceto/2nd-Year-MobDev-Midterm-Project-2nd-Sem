...
public class pizza extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new anywheresoftware.b4a.ShellBA(this.getApplicationContext(), null, null, "b4a.example", "b4a.example.pizza");
...
RDebugUtils.currentModule="pizza";
if (Debug.shouldDelegate(mostCurrent.activityBA, "btnaccept2_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "btnaccept2_click", null));}
RDebugUtils.currentLine=3407872;
 //BA.debugLineNum = 3407872;BA.debugLine="Private Sub btnaccept2_Click";
RDebugUtils.currentLine=3407873;
 //BA.debugLineNum = 3407873;BA.debugLine="Main.priceforpizza = txtprice2.Text";
mostCurrent._main._priceforpizza /*String*/  = mostCurrent._txtprice2.getText();
RDebugUtils.currentLine=3407874;
 //BA.debugLineNum = 3407874;BA.debugLine="Msgbox(\"Transaction Confirmed\",\"Successful\")";
...
RDebugUtils.currentModule="pizza";
if (Debug.shouldDelegate(mostCurrent.activityBA, "btnclear2_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "btnclear2_click", null));}
RDebugUtils.currentLine=3276800;
 //BA.debugLineNum = 3276800;BA.debugLine="Private Sub btnclear2_Click";
RDebugUtils.currentLine=3276801;
 //BA.debugLineNum = 3276801;BA.debugLine="chkham.Checked=False";
mostCurrent._chkham.setChecked(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=3276802;
 //BA.debugLineNum = 3276802;BA.debugLine="chkhaw.Checked=False";
mostCurrent._chkhaw.setChecked(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=3276803;
 //BA.debugLineNum = 3276803;BA.debugLine="chkpep.Checked=False";
mostCurrent._chkpep.setChecked(anywheresoftware.b4a.keywords.Common.False);
RDebugUtils.currentLine=3276804;
 //BA.debugLineNum = 3276804;BA.debugLine="txtprice2.Text =\"0\"";
...
RDebugUtils.currentModule="pizza";
if (Debug.shouldDelegate(mostCurrent.activityBA, "btnhome2_click", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "btnhome2_click", null));}
RDebugUtils.currentLine=3211264;
 //BA.debugLineNum = 3211264;BA.debugLine="Private Sub btnhome2_Click";
RDebugUtils.currentLine=3211265;
 //BA.debugLineNum = 3211265;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
...
RDebugUtils.currentModule="pizza";
if (Debug.shouldDelegate(mostCurrent.activityBA, "chkham_checkedchange", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "chkham_checkedchange", new Object[] {_checked}));}
RDebugUtils.currentLine=1835008;
 //BA.debugLineNum = 1835008;BA.debugLine="Private Sub chkham_CheckedChange(Checked As Boolea";
RDebugUtils.currentLine=1835009;
 //BA.debugLineNum = 1835009;BA.debugLine="If chkham.Checked = True Then";
if (mostCurrent._chkham.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
RDebugUtils.currentLine=1835010;
 //BA.debugLineNum = 1835010;BA.debugLine="txtprice2.Text = txtprice2.Text + 200";
...
RDebugUtils.currentLine=1835012;
 //BA.debugLineNum = 1835012;BA.debugLine="txtprice2.Text = txtprice2.Text - 200";
mostCurrent._txtprice2.setText(BA.ObjectToCharSequence((double)(Double.parseDouble(mostCurrent._txtprice2.getText()))-200));
 };
...
RDebugUtils.currentModule="pizza";
if (Debug.shouldDelegate(mostCurrent.activityBA, "chkhaw_checkedchange", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "chkhaw_checkedchange", new Object[] {_checked}));}
RDebugUtils.currentLine=1769472;
 //BA.debugLineNum = 1769472;BA.debugLine="Private Sub chkhaw_CheckedChange(Checked As Boolea";
RDebugUtils.currentLine=1769473;
 //BA.debugLineNum = 1769473;BA.debugLine="If chkhaw.Checked = True Then";
if (mostCurrent._chkhaw.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
RDebugUtils.currentLine=1769474;
 //BA.debugLineNum = 1769474;BA.debugLine="txtprice2.Text = txtprice2.Text + 300";
...
RDebugUtils.currentLine=1769476;
 //BA.debugLineNum = 1769476;BA.debugLine="txtprice2.Text = txtprice2.Text - 300";
mostCurrent._txtprice2.setText(BA.ObjectToCharSequence((double)(Double.parseDouble(mostCurrent._txtprice2.getText()))-300));
 };
...
RDebugUtils.currentModule="pizza";
if (Debug.shouldDelegate(mostCurrent.activityBA, "chkpep_checkedchange", false))
	 {return ((String) Debug.delegate(mostCurrent.activityBA, "chkpep_checkedchange", new Object[] {_checked}));}
RDebugUtils.currentLine=1703936;
 //BA.debugLineNum = 1703936;BA.debugLine="Private Sub chkpep_CheckedChange(Checked As Boolea";
RDebugUtils.currentLine=1703937;
 //BA.debugLineNum = 1703937;BA.debugLine="If chkpep.Checked = True Then";
if (mostCurrent._chkpep.getChecked()==anywheresoftware.b4a.keywords.Common.True) { 
RDebugUtils.currentLine=1703938;
 //BA.debugLineNum = 1703938;BA.debugLine="txtprice2.Text = txtprice2.Text + 400";
...
RDebugUtils.currentLine=1703940;
 //BA.debugLineNum = 1703940;BA.debugLine="txtprice2.Text = txtprice2.Text - 400";
mostCurrent._txtprice2.setText(BA.ObjectToCharSequence((double)(Double.parseDouble(mostCurrent._txtprice2.getText()))-400));
 };
