...
Debug.ShouldStop(512);
 BA.debugLineNum = 43;BA.debugLine="txtpricepizza.Text = priceforpizza";
Debug.ShouldStop(1024);
main.mostCurrent._txtpricepizza.runMethodAndSync(true,"setText",BA.ObjectToCharSequence(main._priceforpizza));
 BA.debugLineNum = 44;BA.debugLine="txtpricedrinks.Text = pricefordrinks";
...
try {
		Debug.PushSubsStack("btnDrinks_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,78);
if (RapidSub.canDelegate("btndrinks_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btndrinks_click");}
 BA.debugLineNum = 78;BA.debugLine="Private Sub btnDrinks_Click";
Debug.ShouldStop(8192);
 BA.debugLineNum = 79;BA.debugLine="StartActivity(Drinks)";
...
try {
		Debug.PushSubsStack("btnexit_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,83);
if (RapidSub.canDelegate("btnexit_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnexit_click");}
 BA.debugLineNum = 83;BA.debugLine="Private Sub btnexit_Click";
...
try {
		Debug.PushSubsStack("btnPizza_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,73);
if (RapidSub.canDelegate("btnpizza_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btnpizza_click");}
 BA.debugLineNum = 73;BA.debugLine="Private Sub btnPizza_Click";
Debug.ShouldStop(256);
 BA.debugLineNum = 74;BA.debugLine="StartActivity(Pizza)";
Debug.ShouldStop(512);
...
try {
		Debug.PushSubsStack("btntotal_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,68);
if (RapidSub.canDelegate("btntotal_click")) { return b4a.example.main.remoteMe.runUserSub(false, "main","btntotal_click");}
 BA.debugLineNum = 68;BA.debugLine="Private Sub btntotal_Click";
Debug.ShouldStop(8);
 BA.debugLineNum = 69;BA.debugLine="txttotal.Text=txtpricepizza.Text + txtpricedrinks";
Debug.ShouldStop(16);
...
try {
		Debug.PushSubsStack("rdo0_CheckedChange (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,64);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 64;BA.debugLine="Private Sub rdo0_CheckedChange(Checked As Boolean)";
Debug.ShouldStop(-2147483648);
...
try {
		Debug.PushSubsStack("rdo05_CheckedChange (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,60);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 60;BA.debugLine="Private Sub rdo05_CheckedChange(Checked As Boolean";
...
try {
		Debug.PushSubsStack("rdo10_CheckedChange (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,56);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 56;BA.debugLine="Private Sub rdo10_CheckedChange(Checked As Boolean";
...
try {
		Debug.PushSubsStack("rdo20_CheckedChange (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,52);
...
Debug.locals.put("Checked", _checked);
 BA.debugLineNum = 52;BA.debugLine="Private Sub rdo20_CheckedChange(Checked As Boolean";
Debug.ShouldStop(524288);
