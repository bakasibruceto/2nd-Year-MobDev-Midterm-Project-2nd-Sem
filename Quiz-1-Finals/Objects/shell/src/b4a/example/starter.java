...
public static b4a.example.drinks _drinks = null;
  public Object[] GetGlobals() {
		return new Object[] {"Drinks",Debug.moduleToString(b4a.example.drinks.class),"Main",Debug.moduleToString(b4a.example.main.class),"Pizza",Debug.moduleToString(b4a.example.pizza.class),"Service",starter.mostCurrent._service};
}
}